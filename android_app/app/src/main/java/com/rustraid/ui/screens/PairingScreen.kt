...
@Composable fun PairingScreen(pending:Boolean,status:String,onPair:(String,String)->Unit){
 ...
 Column(Modifier.fillMaxSize().padding(24.dp),verticalArrangement=Arrangement.spacedBy(14.dp)){
  ...
  Text("The pairing code is only used to link this phone to one laptop.",style=MaterialTheme.typography.bodySmall)
 }
}
