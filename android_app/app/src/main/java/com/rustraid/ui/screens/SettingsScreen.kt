...
@Composable fun SettingsScreen(settings:AppSettings,onUpdate:(Map<String,Any>)->Unit,onBatteryExemption:()->Unit,onFullScreenPermission:()->Unit,onUnlink:()->Unit,unlinkStatus:String,customSoundUri:String,onCustomSound:(String)->Unit){
