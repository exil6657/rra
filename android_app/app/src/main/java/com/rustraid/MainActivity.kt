...
class MainActivity:ComponentActivity(){
 ...
 @Composable private fun LinkedApp(pairing:PairingInfo,manager:PairingManager){
  val firebase=remember(pairing.laptopId){FirebaseRepository(pairing.laptopId)};var unlinkStatus by remember{mutableStateOf("")};var tab by remember{mutableIntStateOf(0)};var snapshot by remember{mutableStateOf(AlertSnapshot(AlertState.DISCONNECTED))};var entries by remember{mutableStateOf(emptyList<ActivityEntry>())};var settings by remember{mutableStateOf(AppSettings())}
