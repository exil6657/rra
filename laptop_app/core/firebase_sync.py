...
class FirebaseSync(QObject):
    ...
    def send_phone_alarm(self, triggered_at, message='Visual alert detected', mode='critical', vibration=True, flash=True, auto_silence_minutes=5):
